...
public class Newregistrationtableactivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_newregistrationtableactivity);
	...
	public void onValidateClick(View view) {
		...
		String _Passwd = getValueFromDB("_us_password");
		//get and check IMSI
		...
		//validate
		String HTTP_ValidateTableSIM =baseUrl+ "SOP_XML_ValidateTableSIM.aspx?TableUser="+_User+"&IMSI="+_IMSI+"&MSISDN="+_MSISDN;
	...
	{
		private ProgressDialog dialog = new ProgressDialog(Newregistrationtableactivity.this);
		 @Override
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                case XmlPullParser.START_TAG:
                    if (tagname.equalsIgnoreCase("ValidateTableSIM")) {
                    	_Error = "";
                    	_IMSI = "";
                    	_MSISDN = "";
                    }
      ...
      if (requestCode == CAMERA_PIC_REQUEST_PersonalPhoto) {
              if (resultCode == Activity.RESULT_OK) {
                  try {
                	  ...
                	  if (intNbrOfFaces == 0) {
            	            showAlertDialog(newregistrationactivity.this, "Face not detected",
            	                    "Make sure there's enough light and that nothing is in the way and then try again.", false);
            	            return;
                	  } 
                	  if (intNbrOfFaces > 1) {
          	            	showAlertDialog(newregistrationactivity.this, "Multiple Faces detected",
	 ...
	 */
	 private void getNDCMSISDN(String _Barcode){
	    	...
	    	else
	    	{
	            ...
	            showAlertDialog(Newregistrationtableactivity.this, "No Internet Connection",
	...
	public boolean blnCheckDataBeforeUpload() {
		...
		else
		{
			if (_FirstName.length() < 2){
	            ...
	            lblError.setText("First Name is not valid.");
				return false;
			} 
		}*/
		...
		if (_BirthDate.equals("")){
			Toast.makeText(this, "Birth Date cannot be empty.", Toast.LENGTH_LONG).show();
            lblError.setText("Birth Date cannot be empty.");
			return false;			
		}*/
		...
		*/
		...
		strFinalXML = strFinalXML+"<password>"+_Passwd+"</password>";
	...
	public String getValueFromDB(String strValue){
	    ...
	    FeedReaderDbHelper mDbHelper = new FeedReaderDbHelper(Newregistrationtableactivity.this);
    ...
    private String getMyCellId()
    {
		try{
			...
			String sLocation="";
			sLocation=libcls.getMyCellId(this,telephony);
	 ...
	 libClass libcls =new libClass(this);
	...
	public String parseXmltoString(String strXML) {
		...
		try {
			...
			NodeList nl = doc.getElementsByTagName("Reply");  //Tag RowItem

			for (int i = 0; i < nl.getLength(); i++) {
				Element e = (Element) nl.item(i);
				String siteName = libcls.getValues(e, "MESSAGE"); // siteName child value
